...
# ====================================================
# SIDEBAR PORTAL: คืนสิทธิ์ระบบ 4 แถบกล่องไฟสี่สี เขียว-แดง แจ้งเตือนเสถียร 100%
...
# กำหนดตรรกะสีและข้อความของฝั่งควบคุมคุณภาพ (QC)
...
# 定หนดตรรกะสีและข้อความของฝั่งคลังสินค้า (FG)
